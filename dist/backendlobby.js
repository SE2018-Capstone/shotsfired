...
/***/ function(module, exports, __webpack_require__) {
	...
	const child_process = __webpack_require__(12);
	const os = __webpack_require__(13);
	const lobby_server_1 = __webpack_require__(14);
	var app = express();
	...
	new lobby_server_1.LobbyServer(server, game_processes);
...
/***/ function(module, exports, __webpack_require__) {
	...
	class LobbyServer {
	    constructor(server, game_processes) {
	    ...
	    startGame() {
	        ...
	        this.game_processes[this.currentProcess].send('startgame', this.players[this.players.length - 1]);
...
/***/ }
/******/ ]);
//# sourceMappingURL=backendlobby.js.map